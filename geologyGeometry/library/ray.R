...
#' @param alpha A real number, which must be either 0.05 or 0.01.
...
rayMahalanobisPercentiles <- function(us, center, alpha=0.05, numPoints=0, doIsotropic=FALSE) {
  ...
  result <- list(us=us, pvalue=f, center=center, covarInv=covarInv, rotation=rot,
